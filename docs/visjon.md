...
Når noen låser opp døren, vet hjemmet hvem det var. Ikke bare "noen låste opp" — men "Kari låste opp med kode kl 16:43". Aktivitetsloggen er en tidslinje med navn, ikke anonyme hendelser. Fingeravtrykk, kode, RFID, nøkkel, remote — hver metode er tydelig markert.
...
Låsen er en trigger for resten av hjemmet. Når Kari låser opp på hytta fredag ettermiddag, slår varmepumpen seg på, lyset i gangen tennes, og du får et stille varsel på telefonen: "Kari er fremme." Når siste person låser og går, setter hytta seg i hvilemodus — varme ned, lys av, alarmen på.
