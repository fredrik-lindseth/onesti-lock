...
{
  "slots": {
    "0": {"name": "Frode", "has_pin": true, "has_rfid": false},
...
- `sensor.<lock>_slot_0` through `sensor.<lock>_slot_9`
  - State: user name ("Frode") or "Ledig"
  - Attributes: `has_pin`, `has_rfid`, `slot_id`

- `sensor.<lock>_siste_aktivitet`
  - State: human-readable string ("Frode låste opp med kode")
